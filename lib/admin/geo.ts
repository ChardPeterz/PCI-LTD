// Lightweight country -> region + centroid map. Used when geo headers
// are unavailable or partial. Coordinates are rough country centroids
// in [longitude, latitude] order to match VisitorSession.coordinates.
...
const COUNTRY_TABLE: Record<string, CountryInfo> = {
  ...
  TR: { name: "Turkiye", region: "Europe", coords: [35.2, 38.9] },
